...
Actualizado: 2026-07-26 · tip funcional F96 · versión 0.88.0.

- TESTER/PAPER operativos; REAL es alias de PAPER; LIVE routing sigue bloqueado.
- `LIVE_BLOCKED=True`. F96 agrega `GET /api/diagnostics.json` (descarga del
  snapshot F95); F95 `/api/diagnostics`; F94 API Explorer; F93 Venues. Ninguno
  muta estado.
...
- DEC vigente: DEC-140.
- Auditoría noche vigente: `INTERNAL_AUDIT_F19_F95_NIGHT.md` (F96 pendiente).
- No crear `FASE_96_APPROVED.md`; requiere Meta-Auditor externo.

...
| F60 | i18n Scaffold (es default) · **APROBADO_INTERNO** · v0.52.0 |
| F61 | Request Access Log · **APROBADO_INTERNO** · v0.53.0 |
| F62 | Access Log Panel UI · **APROBADO_INTERNO** · v0.54.0 |
| F63 | Session Auto-Backup · **APROBADO_INTERNO** · v0.55.0 |
...
| F68 | Milestone Freeze Docs + CHANGELOG Sync (v0.60) · **APROBADO_INTERNO** · v0.60.0 |
| F69 | Risk Utilization Report · **APROBADO_INTERNO** · v0.61.0 |
| F70 | Paper Kill Switch · **APROBADO_INTERNO** · v0.62.0 |
| F71 | Health Extended + 1000 Tests Milestone · **APROBADO_INTERNO** · v0.63.0 |
| F72 | Desktop Notifications Hook · **APROBADO_INTERNO** · v0.64.0 |
| F73 | Optional Sound Alerts · **APROBADO_INTERNO** · v0.65.0 |
...
| F78 | Milestone Freeze Docs + CHANGELOG Sync (v0.70) · **APROBADO_INTERNO** · v0.70.0 |
| F79 | Watchlist Import/Export JSON · **APROBADO_INTERNO** · v0.71.0 |
| F80 | Custom Preset Save · **APROBADO_INTERNO** · v0.72.0 |
| F81 | Custom Preset Delete · **APROBADO_INTERNO** · v0.73.0 |
| F82 | Window Snap to Edges · **APROBADO_INTERNO** · v0.74.0 |
| F83 | Minimize / Restore All · **APROBADO_INTERNO** · v0.75.0 |
| F84 | Cascade / Tile Windows · **APROBADO_INTERNO** · v0.76.0 |
...
| F93 | Venues / Broker Registry Panel read-only · v0.85.0 |
| F94 | API Explorer Panel read-only · v0.86.0 |
| F95 | Diagnostics Snapshot Panel read-only · v0.87.0 |
| F96 | Diagnostics Download support snapshot · v0.88.0 |
| F97 | Support Bundle ZIP read-only · v0.89.0 |
| F98 | Milestone Freeze arco ops F93–F97 · v0.90.0 |
...
- MD: venues `a3` / `generic_csv` / `generic_rest` + plugins entry-point read-only; `md_source` fake|env
- Specs: [F20](docs/FASE_20_WORKBENCH.md) · [F21](docs/FASE_21_LAB_PANELS.md) · [F22](docs/FASE_22_CHAT_IA.md) · [F23](docs/FASE_23_PAPER_BOOK.md) · [F24](docs/FASE_24_VENUE_MD_PLUGINS.md) · [F25](docs/FASE_25_OPS_DESK.md) · [F26](docs/FASE_26_PAPER_SESSION.md) · [F27](docs/FASE_27_STRATEGY_CATALOG.md) · [plugin contract v1](docs/ops/BROKER_PLUGIN_CONTRACT_V1.md)

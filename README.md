...
| F26 | Paper Session Runner (estrategia → risk → PaperBroker) · v0.18.0 |
...
### Workbench local (F20–F25)

UI loopback (stdlib) con paneles Health / MD / Blotter / Riesgo, Laboratorio y **Chat IA** safe-mode:
...
- Specs: [F20](docs/FASE_20_WORKBENCH.md) · [F21](docs/FASE_21_LAB_PANELS.md) · [F22](docs/FASE_22_CHAT_IA.md) · [F23](docs/FASE_23_PAPER_BOOK.md) · [F24](docs/FASE_24_VENUE_MD_PLUGINS.md) · [F25](docs/FASE_25_OPS_DESK.md) · [plugins](docs/ops/BROKER_PLUGINS.md)

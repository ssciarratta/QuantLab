...
| 10 | CI workflow activo o bloqueo documentado | ✅ | Fuente: `docs/ci/ci.yml.example`. Push de `.github/workflows/ci.yml` bloqueado por OAuth sin scope `workflow` (2026-07-25); restaurar localmente con `cp docs/ci/ci.yml.example .github/workflows/ci.yml` cuando haya PAT con scope `workflow`. |

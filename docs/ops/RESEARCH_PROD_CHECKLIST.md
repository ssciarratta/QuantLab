...
| 10 | CI workflow activo o bloqueo documentado | ✅ | `.github/workflows/ci.yml` versionado (espejo `docs/ci/ci.yml.example`). Escape hatch: `SKIP_WORKFLOWS=1` si el PAT no tiene scope `workflow`. |

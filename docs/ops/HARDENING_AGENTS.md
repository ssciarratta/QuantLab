...
Implementado: `.github/workflows/ci.yml` versionado (espejo `docs/ci/ci.yml.example`). Escape hatch `SKIP_WORKFLOWS=1` si falta scope OAuth `workflow`. `docs/Roadmap.md` → `ROADMAP_ALIGNED.md`.

# Milestone Freeze — Workbench F19–F67 + F68 (v0.60.0)

**Fecha freeze docs:** 2026-07-26  
**Branch:** `cursor/modo-real-workbench-aafd`  
**Milestone tip (hito 0.60):** **v0.60.0** (F68 Milestone Freeze Docs)  
**Último producto previo:** **v0.59.0** (F67 Paper PnL Summary · impl `57b78fd`)  
**LIVE:** **BLOQUEADO** (`LIVE_BLOCKED=True`) · flip **NO**  
**Certificados externos F19–F68:** **NO emitidos** (reserva Meta-Auditor)

> Freeze documental del arco workbench F19–F67 (producto) + F68 (milestone sync).  
> No habilita LIVE. Spec F68: `docs/FASE_68_MILESTONE_V060.md`.

---

## Inventario F19–F67 / F68
...
| Noche F19–F67 | `INTERNAL_AUDIT_F19_F67_NIGHT.md` |
| Noche F19–F68 | `INTERNAL_AUDIT_F19_F68_NIGHT.md` |
| Freeze F19–F67/F68 | este documento |
...
8. Sin emitir `FASE_19`…`FASE_68_APPROVED.md` desde INTERNAL
9. `phases_summary` tip: `F19–F68 INTERNAL`
10. About / health `version` ≡ `quantlab.__version__` y **startswith `0.60`**
...
13. Paper PnL F67 + equity F66 + blotter CSV F65 intactos (research/paper)
...
uv sync --extra dev
uv run quantlab-health                  # ok · live_blocked=true · version 0.60.x
...
# docker build -f Dockerfile.workbench -t quantlab-workbench:0.60.0 .
# docker run --rm -p 127.0.0.1:8765:8765 quantlab-workbench:0.60.0
```
...
| Paper | equity curve (F66); PnL summary (F67); fills CSV (F65) |
...
Smoke tip incluye: `LIVE_BLOCKED is True` · About≡`__version__` · **version starts with 0.60**.
...
| Artifact | Path |
|----------|------|
| Spec F68 | `docs/FASE_68_MILESTONE_V060.md` |
| Noche F19–F68 | `docs/audit/INTERNAL_AUDIT_F19_F68_NIGHT.md` |
| Bundle tip | `reports/QuantLab_Internal_Review_F19_F68_v0.60.0.zip` |
| CHANGELOG agrupado | `CHANGELOG.md` → `[0.60.0]` + resumen F19–F67 |

---

## Firma freeze

Milestone F19–F67 (producto ≤0.59.0) + F68 tip **0.60.0** documentado · **LIVE_BLOCKED** intacto · **sin** certificados externos

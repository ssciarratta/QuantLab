# INTERNAL AUDIT — Noche completa F19–F86

**Fecha:** 2026-07-26  
**Rol:** Meta-Auditor INTERNO (Zero-Trust) QuantLab  
**Branch:** `cursor/modo-real-workbench-aafd`  
**Tip código:** b82485c · **v0.78.0** (Maximize / Restore Window F86)  
**Producto previo:** v0.77.0 (F85 Bring to Front / Send to Back · impl `c1b6d43`)  
**LIVE:** BLOQUEADO · flip **NO** ejecutado

> Extiende `INTERNAL_AUDIT_F19_F85_NIGHT.md` con **F86**.  
> Certificados externos `FASE_19`…`FASE_86_APPROVED.md`: **NO emitidos**.  
...
# NOCHE_F19_F86_APROBADO_INTERNO

| Campo | Valor |
|-------|-------|
| Alcance | F19 OperatingMode → F86 Maximize / Restore Window |
| Veredicto | **APROBADO_INTERNO** (todas las fases del arco) |
| CRITICAL/HIGH abiertos | **Ninguno** |
| Versión tip | **0.78.0** |
| LIVE_BLOCKED | **True** |
| QA tip | mypy 192 · ruff · **1111** pytest · health ok · smoke **71** PASS |
...
| **86** | Maximize / Restore Window | 0.78.0 | b82485c | **APROBADO_INTERNO** | `INTERNAL_AUDIT_F86.md` |
...
| Noche F19–F85 | `INTERNAL_AUDIT_F19_F85_NIGHT.md` | APROBADO_INTERNO |
...
|------------|--------|
| LIVE_BLOCKED | **True** |
| Sin FASE_*_APPROVED F19–F86 | **PASS** |
| About ≡ `__version__` 0.78.0 | **PASS** |
| phases_summary | `F19–F86 INTERNAL` |
| maximize/restoreFromMaximize + preMax + persist maximized | **PASS** |
| titlebar btn/dblclick + commands + menú | **PASS** |
| quantlab-health 0.78.0 · live_blocked | **PASS** |
| Smoke tip | **71/71 PASS** |
...
uv run quantlab-health                  # 0.78.0 · live_blocked=true
uv run python scripts/internal_audit_smoke.py  # 71/71 PASS
```

## Bundle

| Artifact | `reports/QuantLab_Internal_Review_F19_F86_v0.78.0.zip` |
| Manifest | `reports/QuantLab_Internal_Review_F19_F86_v0.78.0_MANIFEST.json` |
| Digest | `ba3f5253b25ea16b9a40dfbf157b0926e0dea468b48221735fe1bcb6aaf2c8dc` |

```text
ba3f5253b25ea16b9a40dfbf157b0926e0dea468b48221735fe1bcb6aaf2c8dc  QuantLab_Internal_Review_F19_F86_v0.78.0.zip
```

> Path: `reports/QuantLab_Internal_Review_F19_F86_v0.78.0.zip` · tip código `b82485c`; re-generar puede cambiar SHA (`created_at_utc`).

---

Meta-Auditor INTERNO Zero-Trust · 2026-07-26 · QuantLab noche F19–F86 · **APROBADO_INTERNO** · **sin** certificados externos · **LIVE_BLOCKED** intacto

# INTERNAL AUDIT — Noche completa F19–F37

**Fecha:** 2026-07-26  
**Rol:** Meta-Auditor INTERNO (Zero-Trust) QuantLab  
**Branch:** `cursor/modo-real-workbench-aafd`  
**Tip código (impl F37):** `81ff9b1` · **v0.29.0** (First-run Onboarding Wizard)  
**LIVE:** BLOQUEADO · flip **NO** ejecutado

> Extiende `INTERNAL_AUDIT_F19_F36_NIGHT.md` con **F37**.  
> Certificados externos `FASE_19`…`FASE_37_APPROVED.md`: **NO emitidos**.  
> Arcos INTERNAL: F19–F22 · F23–F25 · noche F19–F36 · noche F19–F37.

---

## Veredicto noche

# NOCHE_F19_F37_APROBADO_INTERNO

| Campo | Valor |
|-------|-------|
| Alcance | F19 OperatingMode → F37 First-run Onboarding Wizard |
| Veredicto | **APROBADO_INTERNO** (todas las fases del arco) |
| CRITICAL/HIGH abiertos | **Ninguno** |
| Versión tip | **0.29.0** |
| QA tip | mypy 170 · ruff · **689** pytest · health ok · smoke 23 PASS |
...
| Noche F19–F36 | `INTERNAL_AUDIT_F19_F36_NIGHT.md` | **APROBADO_INTERNO** (superseded por esta extensión) |
| Noche F19–F37 | este doc | **APROBADO_INTERNO** |
...
| Onboarding fail-closed (solo meta) | **PASS** |
| Certificados externos F19–F37 | **NO emitidos** |
| Flip LIVE | **NO** |

## QA tip

```text
uv run mypy --strict src/quantlab       # 170 files
uv run ruff check src/quantlab tests scripts
uv run pytest -q                        # 689 passed
uv run quantlab-health                  # 0.29.0 · live_blocked=true
uv run python scripts/internal_audit_smoke.py  # 23/23 PASS
```

## Bundle INTERNAL F19–F37

| Campo | Valor |
|-------|-------|
| Artifact | `reports/QuantLab_Internal_Review_F19_F37_v0.29.0.zip` |
| Generator | `scripts/build_internal_review_bundle.py` · `DEFAULT_TO_PHASE=37` |
| SHA256 | `e3e545a6d1c7f0dc2d5458d8de652c564d797b8a49fcf506a8bf9586219d7d22` |

```text
e3e545a6d1c7f0dc2d5458d8de652c564d797b8a49fcf506a8bf9586219d7d22  QuantLab_Internal_Review_F19_F37_v0.29.0.zip
```

> Digest del artifact regenerado en auditoría INTERNAL (no commitear ZIP).
> Path: `reports/QuantLab_Internal_Review_F19_F37_v0.29.0.zip` · tip docs pre-commit; re-generar puede cambiar SHA (`created_at_utc`).

---

## Alcance / límites

- Cierra la **noche F19–F37** a nivel INTERNAL.  
...
Meta-Auditor INTERNO Zero-Trust · 2026-07-26 · QuantLab noche F19–F37 · **APROBADO_INTERNO**

...
_PANE_COMMANDS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "kind": "pane",
        "label": "Abrir Reconciliación Paper",
        "pane_id": "reconciliation",
    ...
    {
        "id": "open.api_explorer",
        "kind": "pane",
        "label": "Abrir API Explorer",
        "pane_id": "api_explorer",
    ...
    {
        "id": "open.binance_spot",
        "kind": "pane",
        "label": "Abrir Binance Spot Testnet",
        "pane_id": "binance_spot",
        "keywords": ("binance", "spot", "testnet", "demo", "vision"),
    },
    {
        "id": "open.binance_futures",
        "kind": "pane",
        "label": "Abrir Binance Futures Testnet",
        "pane_id": "binance_futures",
        "keywords": ("binance", "futures", "testnet", "perp", "fapi", "demo"),
    },
    {

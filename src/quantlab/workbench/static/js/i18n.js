...
(function (global) {
  ...
  const MESSAGES = {
    es: {
      ...
      "pane.simulator": "Simulador",
      "pane.strategies": "Estrategias",
      ...
      "pane.venues": "Mercados",
      "pane.api_explorer": "API Explorer",
      "pane.diagnostics": "Diagnóstico",
      "pane.guided_lab": "Guided Lab",
    ...
    en: {
      ...
      "pane.backtest": "Backtest",
      "pane.scanner": "Alpha Scanner",
      "pane.simulator": "Simulator",
      "pane.strategies": "Strategies",

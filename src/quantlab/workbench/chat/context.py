...
def build_system_prompt(ctx: dict[str, Any]) -> str:
    ...
    return (
        ...
        "Si pregunta cómo correr alpha/scanner en Binance, respondé exactamente:\n"
        "1) QL (abajo izq) → Guided Lab\n"
        "2) Venue = binance\n"
        "3) Botón «Ranking alpha Binance»\n"
        "4) Revisá el top de monedas\n"
        "5) Para probar MM: elegí inventory_mm → «Backtest top 5 Binance»\n"

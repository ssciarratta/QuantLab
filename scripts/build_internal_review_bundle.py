#!/usr/bin/env python3
"""Empaqueta evidencia INTERNAL F19–F36 para Meta-Auditor externo.
...
Uso:
  ...
  uv run python scripts/build_internal_review_bundle.py --from-phase 19 --to-phase 36
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Empaqueta evidencia INTERNAL (docs/audit) F19–F36 para Meta-Auditor. "

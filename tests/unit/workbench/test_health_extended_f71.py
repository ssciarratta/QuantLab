...
def test_build_about_payload_includes_ops_flags_defaults() -> None:
    ...
    assert payload["version"] == "0.88.0"
    assert payload["phases_summary"] == "F19–F96 INTERNAL"
...
def test_about_ops_flags_defaults(tmp_path: Path) -> None:
    ...
    assert about["phases_summary"] == "F19–F96 INTERNAL"

...
**Alpha Scanner opt:** FASE 0–10 código completo (`docs/progress/alpha-scanner-optimization-status.md`, `docs/scanner/alpha-scanner-guide.md`); scoring default `legacy_v1`; sin certificado formal
...
- Monte Carlo improvement FASE 1–12 (tras FASE 0 audit): trazabilidad Scan→BT→MC
  · audit: `docs/montecarlo/current-montecarlo-audit.md`
